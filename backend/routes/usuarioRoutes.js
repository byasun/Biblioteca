...
const validate = require('../middleware/validator'); // Verifique o caminho
...
router.post('/login',
    ...
    validate.login, // Use diretamente aqui
...
router.get('/',
    ...
    validate.queryParams(['page', 'limit', 'sort']), // Use diretamente aqui
    usuarioController.listarUsuarios
);

router.delete('/:id',
    validate.params('id'), // Use diretamente aqui
    usuarioController.deletarUsuario
);

router.get('/buscar',
    cache(60),
    validate.queryParams(['nome', 'email']), // Use diretamente aqui
